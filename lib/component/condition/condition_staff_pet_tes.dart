...
class ConditionStaffPetTes extends StatefulWidget {
  const ConditionStaffPetTes(
  ...
  @override
  State<ConditionStaffPetTes> createState() => _ConditionStaffPetTes();
}

class _ConditionStaffPetTes extends State<ConditionStaffPetTes> {

...
class PaymentPaidList extends StatefulWidget {
  const PaymentPaidList(
      {super.key, required this.dataPaid, required this.status});
  final List<Map<String, dynamic>> dataPaid;
  final String status;

  @override
  State<PaymentPaidList> createState() => _PaymentPaidListState();
}

class _PaymentPaidListState extends State<PaymentPaidList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      itemCount: widget.dataPaid.length,
      itemBuilder: (context, index) {
        final historyPaymentPaid = widget.dataPaid[index];

...
class ReservationCancelList extends StatefulWidget {
  const ReservationCancelList(
      {super.key, required this.dataCancel, required this.status});
  final List<Map<String, dynamic>> dataCancel;
  final String status;

  @override
  State<ReservationCancelList> createState() => _ReservationCancelListState();
}

class _ReservationCancelListState extends State<ReservationCancelList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      itemCount: widget.dataCancel.length,
      itemBuilder: (context, index) {
        final historyAccept = widget.dataCancel[index];
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "Pesanan dibatalkan, sampai jumpa lain waktu.",
                                            maxLines: 2,
                                            style: TextStyle(

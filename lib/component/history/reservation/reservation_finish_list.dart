...
import '../../../screen/tes/rating_tes.dart';

class ReservationFinishList extends StatefulWidget {
  const ReservationFinishList(
      {super.key, required this.dataFinish, required this.status});
  final List<Map<String, dynamic>> dataFinish;
  final String status;

  @override
  State<ReservationFinishList> createState() => _ReservationFinishListState();
}

class _ReservationFinishListState extends State<ReservationFinishList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      itemCount: widget.dataFinish.length,
      itemBuilder: (context, index) {
        final historyAccept = widget.dataFinish[index];

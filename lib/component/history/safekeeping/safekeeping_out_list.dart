...
class SafeKeepingOutList extends StatefulWidget {
  const SafeKeepingOutList(
      {super.key, required this.dataOut, required this.status});
  final List<Map<String, dynamic>> dataOut;
  final String status;

  @override
  State<SafeKeepingOutList> createState() => _SafeKeepingOutListState();
}

class _SafeKeepingOutListState extends State<SafeKeepingOutList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      itemCount: widget.dataOut.length,
      itemBuilder: (context, index) {
        final historyAccept = widget.dataOut[index];
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            "Terimakasih sudah menitipkan hewan anda.",
                                            style: TextStyle(

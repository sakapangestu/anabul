...
class UserPanelUpdatePhoto extends StatefulWidget {
  final PanelController pc;
  final Function(XFile?) updateImage;
  final ImagePicker picker;
  final String title;

  const UserPanelUpdatePhoto({
    Key? key,
    required this.title,
    required this.pc,
  ...
  @override
  _UserPanelUpdatePhoto createState() => _UserPanelUpdatePhoto();
}

class _UserPanelUpdatePhoto extends State<UserPanelUpdatePhoto> {

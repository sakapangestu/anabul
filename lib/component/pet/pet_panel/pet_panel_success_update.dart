...
class PetPanelSuccessUpdate extends StatefulWidget {
  final PanelController? pc;

  const PetPanelSuccessUpdate({Key? key, this.pc}) : super(key: key);

  @override
  _PetPanelSuccessUpdate createState() => _PetPanelSuccessUpdate();
}

class _PetPanelSuccessUpdate extends State<PetPanelSuccessUpdate> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Hewan anda berhasil ditambah. Silahkan kembali ke beranda untuk menggunakan aplikasi.",
                          style: TextStyle(
                            fontSize: 10.sp,
                            color: globalColors.textBlackBold,

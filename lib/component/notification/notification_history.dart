...
class NotificationHistory extends StatefulWidget {
  ...
  @override
  State<NotificationHistory> createState() => _NotificationHistory();
}
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<List<Map<String, dynamic>>>(
          future: History.getHistoryNotification(),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              final historyNotification = snapshot.data!;
              // print("notif isi pa: $historyNotification");
              return ListView.builder(
                itemCount: historyNotification.length,
                itemBuilder: (context, index) {
                  final dataNotif = historyNotification[index];

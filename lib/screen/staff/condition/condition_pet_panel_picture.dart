...
class ConditionPetPanelPicture extends StatefulWidget {

  final PanelController? pc;

  const ConditionPetPanelPicture({
    Key? key,
    this.pc
  }) : super(key: key);

  @override
  _ConditionPetPanelPicture createState() => _ConditionPetPanelPicture();

}

class _ConditionPetPanelPicture extends State<ConditionPetPanelPicture> {

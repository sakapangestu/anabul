...
class DetailUserTes extends StatefulWidget {
  const DetailUserTes({Key? key, required this.user}) : super(key: key);
  final Map<String, dynamic> user;

  @override
  _DetailUserTes createState() => _DetailUserTes();
}

class _DetailUserTes extends State<DetailUserTes> {
  ...
  void initState() {
    ...
    if (widget.user['province'] != null &&
        widget.user['province']!.isNotEmpty) {
    ...
    if (widget.user['subdistrict'] != null &&
        widget.user['subdistrict']!.isNotEmpty) {
                          ...
                          DropdownSearch<String>(
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                tempProvince = selectedProvinceId!;
                          ...
                          DropdownSearch<String>(
                            ...
                            onChanged: (value) {
                              ...
                              setState(() {
                                ...
                                tempDistrict = selectedDistrictId!;
                          ...
                          DropdownSearch<String>(
                            ...
                            onChanged: (value) {
                              ...
                              setState(() {
                                ...
                                tempSubDistrict = selectedSubDistrictId!;
                              });
                            },
